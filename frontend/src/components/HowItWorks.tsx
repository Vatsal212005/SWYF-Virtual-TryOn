...
const HowItWorks = () => {
  return <section id="how-it-works" className="bg-accent/20 py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-4">
          {/* Step 1 */}
          <div className="bg-white rounded-xl shadow-md p-6 relative flex flex-col items-center text-center group hover:shadow-lg transition-shadow">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center shadow-md">
              <span className="font-bold">1</span>
            </div>
            <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mb-5 mt-3 group-hover:bg-primary/20 transition-colors">
        ...
        <div className="mt-16 pt-8 border-t border-border/40 text-center">
          ...
          <a href="#try-now" className="inline-block px-6 py-3 rounded-full bg-primary text-primary-foreground font-medium hover:bg-primary/90 transition-all shadow-lg hover:shadow-primary/20">Try SWYF Now</a>
        </div>
      </div>
    </section>;
};
